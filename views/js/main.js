...
var pizzasDiv = document.getElementById("randomPizzas");    //removed from loop
for (var i = 2; i < 100; i++) {
...
//Code for working with requestAnimationFrame() taken from
...
document.addEventListener('DOMContentLoaded', function() {
  var cols = 8;
  var s = 256;
  var movingPizzas = document.querySelector("#movingPizzas1");  //removed querySelector from loop
  for (var i = 0; i < 32; i++) {
